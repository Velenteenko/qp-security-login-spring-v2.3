...
<head>
    ...
    <link rel="stylesheet"
          href='<spring:url value="/css/custom.css"/>' />
</head>
...
<%--<div class="container">--%>
    <%--<p class="text-muted">&copy; 2015 ПАО "ВАЗ" - електронный документооборот</p>--%>
<%--</div>--%>
<%--</footer>--%>
...
<%--<div id="login-form">--%>
    ...
    <%--<form:form role="form" action="${url }" method="POST">--%>
        ...
        <%--<div class="form-group">--%>
            <%--<label for="password">Пароль</label>--%>
            <%--<input id="c" type="password" class="form-control" required="required" name="password"--%>
                   <%--placeholder="Пароль">--%>
        <%--</div>--%>
        <%--<button type="submit" class="btn btn-default">Войти</button>--%>
    <%--</form:form>--%>
